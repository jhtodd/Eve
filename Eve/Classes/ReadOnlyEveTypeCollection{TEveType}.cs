...
namespace Eve
{
  ...
  public partial class ReadOnlyEveTypeCollection<TEveType>
    : ReadOnlyRepositoryItemCollection<TEveType>
    where TEveType : EveType
  {
    ...
    /// collection.
    /// </param>
    internal ReadOnlyEveTypeCollection(IEveRepository repository) : base(repository)
    {
    ...
    /// </returns>
    public static ReadOnlyEveTypeCollection<TEveType> Create(IEveRepository repository, IEnumerable<TEveType> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyEveTypeCollection<TEveType>(repository);
