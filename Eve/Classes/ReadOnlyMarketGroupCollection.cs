...
namespace Eve
{
  ...
  public sealed partial class ReadOnlyMarketGroupCollection
    : ReadOnlyKeyedEntityAdapterCollection<MarketGroupId, MarketGroupEntity, MarketGroup>
  {
    /* Constructors */
    ...
    /// </param>
    public ReadOnlyMarketGroupCollection(IEveRepository repository, IEnumerable<MarketGroup> contents)
    ...
    /// </param>
    public ReadOnlyMarketGroupCollection(IEveRepository repository, IEnumerable<MarketGroupEntity> entities)
