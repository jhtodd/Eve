...
namespace Eve
{
      ...
      IAttributeCollection
  {
    ...
    /// </param>
    internal ReadOnlyAttributeValueCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyAttributeValueCollection Create(IEveRepository repository, IEnumerable<AttributeValue> contents)
    {
      ...
      var result = new ReadOnlyAttributeValueCollection(repository, contents == null ? 0 : contents.Count());
