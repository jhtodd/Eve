...
namespace Eve
{
    ...
    : ReadOnlyRepositoryItemCollection<MetaType>
  {
    ...
    /// </param>
    internal ReadOnlyMetaTypeCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyMetaTypeCollection Create(IEveRepository repository, IEnumerable<MetaType> contents)
    {
      ...
      var result = new ReadOnlyMetaTypeCollection(repository, contents == null ? 0 : contents.Count());
