//-----------------------------------------------------------------------
// <copyright file="GraphicEntity.cs" company="Jeremy H. Todd">
...
namespace Eve.Data.Entities
{
  ...
  public class GraphicEntity : EveEntity<Graphic>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the GraphicEntity class.
    /// </summary>
    public GraphicEntity() : base()
    {
    }
    ...
    /// <inheritdoc />
    public override Graphic ToAdapter(IEveRepository repository)
    {
      ...
      return new Graphic(repository, this);
    }
  }
}