...
namespace Eve.Data.Entities
{
  ...
  public class StationEntity : ItemExtensionEntity
  {
    ...
    public double MaxShipVolumeDockable { get; internal set; }
    ...
    public int OfficeRentalCost { get; internal set; }
    ...
    public byte ReprocessingHangarFlag { get; internal set; }
    ...
    public double ReprocessingStationsTake { get; internal set; }
    ...
    /// </value>
    [Column("security")]
    public short Security { get; internal set; }
