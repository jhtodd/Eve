...
namespace Eve.Universe
{
  ...
  /// <summary>
  /// A read-only collection of <see cref="Region" /> objects.
  /// </summary>
  [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2237:MarkISerializableTypesWithSerializable", Justification = "Base class implements ISerializable but the contents of the collection cannot be serialized.")]
  public sealed partial class ReadOnlyRegionCollection
    : ReadOnlyRepositoryItemCollection<Region>
  {
    /* Constructors */
    ...
    /// </param>
    internal ReadOnlyRegionCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    /// <summary>
    /// Creates a new instance of the ReadOnlyRegionCollection class.
    /// </summary>
    /// <param name="repository">
    /// The <see cref="IEveRepository" /> associated with the items in the 
    /// collection.
    ...
    /// </returns>
    public static ReadOnlyRegionCollection Create(IEveRepository repository, IEnumerable<Region> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyRegionCollection(repository, contents == null ? 0 : contents.Count());
    ...
    /// A newly created collection containing the specified items.
    /// </returns>
    public static ReadOnlyRegionCollection Create(IEveRepository repository, IEnumerable<RegionEntity> entities)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");
