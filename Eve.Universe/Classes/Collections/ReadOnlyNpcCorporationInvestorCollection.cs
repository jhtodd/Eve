...
namespace Eve.Universe
{
    ...
    : ReadOnlyRepositoryItemCollection<NpcCorporationInvestor>
  {
    ...
    /// </param>
    internal ReadOnlyNpcCorporationInvestorCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyNpcCorporationInvestorCollection Create(IEveRepository repository, IEnumerable<NpcCorporationInvestor> contents)
    {
      ...
      var result = new ReadOnlyNpcCorporationInvestorCollection(repository, contents == null ? 0 : contents.Count());
