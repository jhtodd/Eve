...
namespace Eve.Universe
{
  ...
  public sealed partial class ReadOnlyConstellationCollection
    : ReadOnlyRepositoryItemCollection<Constellation>
  {
    /* Constructors */
    ...
    /// </param>
    internal ReadOnlyConstellationCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    /// <summary>
    /// Creates a new instance of the ReadOnlyConstellationCollection class.
    /// </summary>
    /// <param name="repository">
    /// The <see cref="IEveRepository" /> associated with the items in the 
    /// collection.
    ...
    /// </returns>
    public static ReadOnlyConstellationCollection Create(IEveRepository repository, IEnumerable<Constellation> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyConstellationCollection(repository, contents == null ? 0 : contents.Count());
    ...
    /// A newly created collection containing the specified items.
    /// </returns>
    public static ReadOnlyConstellationCollection Create(IEveRepository repository, IEnumerable<ConstellationEntity> entities)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");
