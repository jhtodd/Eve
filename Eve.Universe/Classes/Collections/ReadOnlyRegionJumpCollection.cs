...
namespace Eve.Universe
{
    ...
    : ReadOnlyRepositoryItemCollection<RegionJump>
  {
    ...
    /// </param>
    internal ReadOnlyRegionJumpCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyRegionJumpCollection Create(IEveRepository repository, IEnumerable<RegionJump> contents)
    {
      ...
      var result = new ReadOnlyRegionJumpCollection(repository, contents == null ? 0 : contents.Count());
