...
namespace Eve.Universe
{
    ...
    : ReadOnlyRepositoryItemCollection<SolarSystem>
  {
    ...
    /// </param>
    internal ReadOnlySolarSystemCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlySolarSystemCollection Create(IEveRepository repository, IEnumerable<SolarSystem> contents)
    {
      ...
      var result = new ReadOnlySolarSystemCollection(repository, contents == null ? 0 : contents.Count());
