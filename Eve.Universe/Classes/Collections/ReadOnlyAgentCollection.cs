...
namespace Eve.Universe
{
  ...
  public sealed partial class ReadOnlyAgentCollection
    : ReadOnlyRepositoryItemCollection<Agent>
  {
    /* Constructors */
    ...
    /// </param>
    internal ReadOnlyAgentCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    /// </returns>
    public static ReadOnlyAgentCollection Create(IEveRepository repository, IEnumerable<Agent> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyAgentCollection(repository, contents == null ? 0 : contents.Count());
    ...
    /// A newly created collection containing the specified items.
    /// </returns>
    public static ReadOnlyAgentCollection Create(IEveRepository repository, IEnumerable<AgentEntity> entities)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");
