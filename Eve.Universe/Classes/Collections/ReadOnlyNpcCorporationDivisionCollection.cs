...
namespace Eve.Universe
{
    ...
    : ReadOnlyKeyedRepositoryItemCollection<DivisionId, NpcCorporationDivision>
  {
    ...
    /// </param>
    internal ReadOnlyNpcCorporationDivisionCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyNpcCorporationDivisionCollection Create(IEveRepository repository, IEnumerable<NpcCorporationDivision> contents)
    {
      ...
      var result = new ReadOnlyNpcCorporationDivisionCollection(repository, contents == null ? 0 : contents.Count());
