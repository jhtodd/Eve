...
namespace Eve.Universe
{
  ...
  public sealed partial class ReadOnlySolarSystemJumpCollection
    : ReadOnlyEntityAdapterCollection<SolarSystemJumpEntity, SolarSystemJump>
  {
    /* Constructors */
    ...
    /// </param>
    public ReadOnlySolarSystemJumpCollection(IEveRepository repository, IEnumerable<SolarSystemJump> contents)
    ...
    /// </param>
    public ReadOnlySolarSystemJumpCollection(IEveRepository repository, IEnumerable<SolarSystemJumpEntity> entities)
