...
namespace Eve.Universe
{
  ...
  public sealed partial class ReadOnlyRegionCollection
    : ReadOnlyEntityAdapterCollection<RegionEntity, Region>
  {
    /* Constructors */
    ...
    /// </param>
    public ReadOnlyRegionCollection(IEveRepository repository, IEnumerable<Region> contents)
    ...
    /// </param>
    public ReadOnlyRegionCollection(IEveRepository repository, IEnumerable<RegionEntity> entities)
