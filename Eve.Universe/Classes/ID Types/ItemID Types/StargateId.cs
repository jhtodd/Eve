//-----------------------------------------------------------------------
// <copyright file="StargateId.cs" company="Jeremy H. Todd">
...
namespace Eve.Universe
{
  ...
  /// <summary>
  /// Represents an ID value for the <see cref="Stargate" /> class.
  /// </summary>
  public partial struct StargateId 
    : IConvertible,
      IEquatable<StargateId>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the StargateId structure.
    /// </summary>
    /// <param name="value">
    /// The value of the structure.
    /// </param>
    public StargateId(long value)
    {
      this.value = value;
    }
    ...
    /// <see langword="false" />.
    /// </returns>
    public static bool operator ==(StargateId left, StargateId right)
    {
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator StargateId(long value)
    {
      return new StargateId(value);
    }
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator long(StargateId value)
    {
      return value.Value;
    }
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator ItemId(StargateId value)
    {
      // StargateId "derives" from ItemId and can always be converted to it
      // (but not vice versa).
    ...
    public override bool Equals(object obj)
    {
      ...
      if (!typeof(StargateId).IsAssignableFrom(obj.GetType()))
      {
        return false;
      }

      return this.Equals((StargateId)obj);
    }

    /// <inheritdoc />
    public bool Equals(StargateId other)
    {
  ...
  /// </content>
  public partial struct StargateId : IConvertible
  {
