//-----------------------------------------------------------------------
// <copyright file="CelestialId.cs" company="Jeremy H. Todd">
...
namespace Eve.Universe
{
  ...
  /// <summary>
  /// Represents an ID value for the <see cref="Celestial" /> class.
  /// </summary>
  public partial struct CelestialId 
    : IConvertible,
      IEquatable<CelestialId>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the CelestialId structure.
    /// </summary>
    /// <param name="value">
    /// The value of the structure.
    /// </param>
    public CelestialId(long value)
    {
      this.value = value;
    }
    ...
    /// <see langword="false" />.
    /// </returns>
    public static bool operator ==(CelestialId left, CelestialId right)
    {
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator CelestialId(long value)
    {
      return new CelestialId(value);
    }
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator long(CelestialId value)
    {
      return value.Value;
    }
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator ItemId(CelestialId value)
    {
      // CelestialId "derives" from ItemId and can always be converted to it
      // (but not vice versa).
    ...
    public override bool Equals(object obj)
    {
      ...
      if (!typeof(CelestialId).IsAssignableFrom(obj.GetType()))
      {
        return false;
      }

      return this.Equals((CelestialId)obj);
    }

    /// <inheritdoc />
    public bool Equals(CelestialId other)
    {
  ...
  /// </content>
  public partial struct CelestialId : IConvertible
  {
