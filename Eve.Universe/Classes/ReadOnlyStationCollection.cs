...
namespace Eve.Universe
{
  ...
  public sealed partial class ReadOnlyStationCollection
    : ReadOnlyEntityAdapterCollection<StationEntity, Station>
  {
    /* Constructors */
    ...
    /// </param>
    public ReadOnlyStationCollection(IEveRepository repository, IEnumerable<Station> contents)
    ...
    /// </param>
    public ReadOnlyStationCollection(IEveRepository repository, IEnumerable<StationEntity> entities)
