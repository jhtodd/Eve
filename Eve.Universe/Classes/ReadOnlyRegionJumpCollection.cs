...
namespace Eve.Universe
{
  ...
  public sealed partial class ReadOnlyRegionJumpCollection
    : ReadOnlyEntityAdapterCollection<RegionJumpEntity, RegionJump>
  {
    /* Constructors */
    ...
    /// </param>
    public ReadOnlyRegionJumpCollection(IEveRepository repository, IEnumerable<RegionJump> contents)
    ...
    /// </param>
    public ReadOnlyRegionJumpCollection(IEveRepository repository, IEnumerable<RegionJumpEntity> entities)
