...
namespace Eve.Universe
{
  ...
  public sealed partial class ContrabandInfo
    : EveEntityAdapter<ContrabandInfoEntity>,
      IComparable,
      IComparable<ContrabandInfo>,
      IEquatable<ContrabandInfo>,
      IEveCacheable,
      IKeyItem<long>
  {
    ...
    /// <inheritdoc />
    public int CompareTo(ContrabandInfo other)
    {
      if (other == null)
      {
        return 1;
    ...
    {
      return this.Equals(obj as ContrabandInfo);
    }

    /// <inheritdoc />
    public bool Equals(ContrabandInfo other)
    {
      if (other == null)
      {
        return false;
  ...
  /// </content>
  public partial class ContrabandInfo : IComparable
  {
    int IComparable.CompareTo(object obj)
    {
      ContrabandInfo other = obj as ContrabandInfo;
