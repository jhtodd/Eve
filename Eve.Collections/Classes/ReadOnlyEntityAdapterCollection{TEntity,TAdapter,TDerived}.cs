//-----------------------------------------------------------------------
// <copyright file="ReadOnlyEntityAdapterCollection{TEntity,TAdapter,TDerived}.cs" company="Jeremy H. Todd">
...
namespace Eve
{
  ...
  public class ReadOnlyEntityAdapterCollection<TEntity, TAdapter, TDerived> : ReadOnlyRepositoryItemCollection<TDerived>
    where TEntity : IEveEntity<TAdapter>
    where TAdapter : IEveCacheable, IEveRepositoryItem
    where TDerived : TAdapter
  {
    /* Constructors */
    ...
    /// </param>
    public ReadOnlyEntityAdapterCollection(IEveRepository repository, IEnumerable<TDerived> contents)
