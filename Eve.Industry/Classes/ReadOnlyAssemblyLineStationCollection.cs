...
namespace Eve.Industry
{
  ...
  public sealed partial class ReadOnlyAssemblyLineStationCollection
    : ReadOnlyRepositoryItemCollection<AssemblyLineStation>
  {
    /* Constructors */
    ...
    /// collection.
    /// </param>
    internal ReadOnlyAssemblyLineStationCollection(IEveRepository repository) : base(repository)
    {
    ...
    /// <summary>
    /// Creates a new instance of the ReadOnlyAssemblyLineStationCollection class.
    /// </summary>
    /// <param name="repository">
    /// The <see cref="IEveRepository" /> associated with the items in the 
    /// collection.
    ...
    /// </returns>
    public static ReadOnlyAssemblyLineStationCollection Create(IEveRepository repository, IEnumerable<AssemblyLineStation> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyAssemblyLineStationCollection(repository);
    ...
    /// A newly created collection containing the specified items.
    /// </returns>
    public static ReadOnlyAssemblyLineStationCollection Create(IEveRepository repository, IEnumerable<AssemblyLineStationEntity> entities)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");
