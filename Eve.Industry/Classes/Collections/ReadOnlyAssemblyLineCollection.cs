...
namespace Eve.Industry
{
  ...
  public sealed partial class ReadOnlyAssemblyLineCollection
    : ReadOnlyRepositoryItemCollection<AssemblyLine>
  {
    /* Constructors */
    ...
    /// </param>
    internal ReadOnlyAssemblyLineCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    /// <summary>
    /// Creates a new instance of the ReadOnlyAssemblyLineCollection class.
    /// </summary>
    /// <param name="repository">
    /// The <see cref="IEveRepository" /> associated with the items in the 
    /// collection.
    ...
    /// </returns>
    public static ReadOnlyAssemblyLineCollection Create(IEveRepository repository, IEnumerable<AssemblyLine> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyAssemblyLineCollection(repository, contents == null ? 0 : contents.Count());
    ...
    /// A newly created collection containing the specified items.
    /// </returns>
    public static ReadOnlyAssemblyLineCollection Create(IEveRepository repository, IEnumerable<AssemblyLineEntity> entities)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");
