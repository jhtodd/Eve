...
namespace Eve.Industry
{
    ...
    : ReadOnlyRepositoryItemCollection<AssemblyLineStation>
  {
    ...
    /// </param>
    internal ReadOnlyAssemblyLineStationCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyAssemblyLineStationCollection Create(IEveRepository repository, IEnumerable<AssemblyLineStation> contents)
    {
      ...
      var result = new ReadOnlyAssemblyLineStationCollection(repository, contents == null ? 0 : contents.Count());
