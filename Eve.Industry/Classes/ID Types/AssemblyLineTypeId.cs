//-----------------------------------------------------------------------
// <copyright file="AssemblyLineTypeId.cs" company="Jeremy H. Todd">
...
namespace Eve
{
  ...
  /// </summary>
  public partial struct AssemblyLineTypeId 
    : IConvertible,
      IEquatable<AssemblyLineTypeId>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the AssemblyLineTypeId structure.
    /// </summary>
    /// <param name="value">
    /// The value of the structure.
    /// </param>
    public AssemblyLineTypeId(byte value)
    {
      this.value = value;
    }
    ...
    /// <see langword="false" />.
    /// </returns>
    public static bool operator ==(AssemblyLineTypeId left, AssemblyLineTypeId right)
    {
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator AssemblyLineTypeId(byte value)
    {
      return new AssemblyLineTypeId(value);
    }
    ...
    /// The converted value.
    /// </returns>
    public static implicit operator byte(AssemblyLineTypeId value)
    {
      return value.Value;
    }
    ...
    public override bool Equals(object obj)
    {
      ...
      if (!typeof(AssemblyLineTypeId).IsAssignableFrom(obj.GetType()))
      {
        return false;
      }

      return this.Equals((AssemblyLineTypeId)obj);
    }

    /// <inheritdoc />
    public bool Equals(AssemblyLineTypeId other)
    {
  ...
  /// </content>
  public partial struct AssemblyLineTypeId : IConvertible
  {
