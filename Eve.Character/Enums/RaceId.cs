...
namespace Eve.Character
{
  ...
  [Description("Contains the ID values associated with the Race class.")]
  [Flags()]
  public enum RaceId : byte
  {
    ...
    [Description("Jove")]
    [LongDescription("The most mysterious and elusive of all the universe\'s peoples, the Jovians number" +
