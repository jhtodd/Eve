...
namespace Eve.Character
{
  ...
  /// <summary>
  /// Contains information about recommended certificates for a ship type.
  /// </summary>
  public sealed partial class CertificateRecommendation
    : EveEntityAdapter<CertificateRecommendationEntity, CertificateRecommendation>,
      IKeyItem<CertificateRecommendationId>
  {
    ...
    /// <inheritdoc />
    public override int CompareTo(CertificateRecommendation other)
    {
      if (other == null)
      {
        return 1;
