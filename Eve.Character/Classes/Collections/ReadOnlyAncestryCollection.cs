...
namespace Eve.Character
{
    ...
    : ReadOnlyKeyedRepositoryItemCollection<AncestryId, Ancestry>
  {
    ...
    /// </param>
    public ReadOnlyAncestryCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyAncestryCollection Create(IEveRepository repository, IEnumerable<Ancestry> contents)
    {
      ...
      var result = new ReadOnlyAncestryCollection(repository, contents == null ? 0 : contents.Count());
