...
namespace Eve.Character
{
    ...
    : ReadOnlyKeyedRepositoryItemCollection<SkillId, SkillLevel>
  {
    ...
    /// </param>
    internal ReadOnlySkillLevelCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlySkillLevelCollection Create(IEveRepository repository, IEnumerable<SkillLevel> contents)
    {
      ...
      var result = new ReadOnlySkillLevelCollection(repository, contents == null ? 0 : contents.Count());
