...
namespace Eve.Character
{
  ...
  public sealed partial class ReadOnlyBloodlineCollection
    : ReadOnlyKeyedRepositoryItemCollection<BloodlineId, Bloodline>
  {
    /* Constructors */
    ...
    /// </param>
    internal ReadOnlyBloodlineCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    /// </returns>
    public static ReadOnlyBloodlineCollection Create(IEveRepository repository, IEnumerable<Bloodline> contents)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");

      var result = new ReadOnlyBloodlineCollection(repository, contents == null ? 0 : contents.Count());
    ...
    /// A newly created collection containing the specified items.
    /// </returns>
    public static ReadOnlyBloodlineCollection Create(IEveRepository repository, IEnumerable<BloodlineEntity> entities)
    {
      Contract.Requires(repository != null, "The provided repository cannot be null.");
