...
namespace Eve.Character
{
    ...
    : ReadOnlyRepositoryItemCollection<CertificateRelationship>
  {
    ...
    /// </param>
    internal ReadOnlyCertificateRelationshipCollection(IEveRepository repository, int capacity) : base(repository, capacity)
    {
    ...
    public static ReadOnlyCertificateRelationshipCollection Create(IEveRepository repository, IEnumerable<CertificateRelationship> contents)
    {
      ...
      var result = new ReadOnlyCertificateRelationshipCollection(repository, contents == null ? 0 : contents.Count());
