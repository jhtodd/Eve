...
namespace Eve.Character
{
  ...
  public sealed partial class CertificateRelationship
    : EveEntityAdapter<CertificateRelationshipEntity>,
      IComparable,
      IComparable<CertificateRelationship>,
      IEquatable<CertificateRelationship>,
      IEveCacheable,
      IKeyItem<CertificateRelationshipId>
  {
    ...
    /// <inheritdoc />
    public int CompareTo(CertificateRelationship other)
    {
      if (other == null)
      {
        return 1;
    ...
    {
      return this.Equals(obj as CertificateRelationship);
    }

    /// <inheritdoc />
    public bool Equals(CertificateRelationship other)
    {
      if (other == null)
      {
        return false;
  ...
  /// </content>
  public sealed partial class CertificateRelationship : IComparable
  {
    int IComparable.CompareTo(object obj)
    {
      CertificateRelationship other = obj as CertificateRelationship;
