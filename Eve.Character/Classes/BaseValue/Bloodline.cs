      ...
      IHasIcon
  {
    ...
    public EveType ShipType // TODO: Change to ShipType
    {
      get
      {
        ...
        // If not already set, load from the cache, or else create an instance from the base entity
        return this.shipType ?? (this.shipType = this.Container.Cache.GetOrAdd<EveType>(this.ShipTypeId, () => this.Entity.ShipType.ToAdapter(this.Container)));
      }
    }
    ...
    public Race Race
    {
      get
      {
        ...
        // If not already set, load from the cache, or else create an instance from the base entity
        return this.race ?? (this.race = this.Container.Cache.GetOrAdd<Race>(this.RaceId, () => this.Entity.Race.ToAdapter(this.Container)));
      }
    }
