//-----------------------------------------------------------------------
// <copyright file="BloodlineEntity.cs" company="Jeremy H. Todd">
...
namespace Eve.Data.Entities
{
  ...
  [Table("chrBloodlines")]
  public class BloodlineEntity : BaseValueEntity<BloodlineId>
  {
    ...
    /// <summary>
    /// Initializes a new instance of the BloodlineEntity class.
    /// </summary>
    public BloodlineEntity() : base()
    {
    }
    ...
    public EveTypeEntity ShipType { get; set; } // TODO: Change to ShipType once implemented
    ...
    /// </value>
    [Column("shipTypeID")]
    public TypeId ShipTypeId { get; set; }
